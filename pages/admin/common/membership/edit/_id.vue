<template>
  <div>
    <div class="top">
      <STitle class="mb-16 mr-16" emoji="pencil">멤버십 {{ isNew ? '등록' : '수정' }}</STitle>
    </div>
    ...
    <div class="edit-area">
      ...
      <div class="bottom">
        ...
        <div class="right">
          <SButton class="mr-8">초기화</SButton>
...
export default {
  ...
  async asyncData({ $axios, params, $dayjs }) {
    ...
    return { id, isNew, detailData, detailImageFileName };
  },
  data() {
    return {
      id: null,
